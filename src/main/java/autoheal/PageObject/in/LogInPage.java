...
public class LogInPage {
	...
	// In LoginButtonLocator the primary locator (id:login-buttonn) is deliberately broken.
	// If it fails, the framework automatically retries the secondary locator("xpath://input[@value='Login']").
